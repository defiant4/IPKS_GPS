        ...
        <div id='cssmenu'>
            <ul>
                ...
                <li class='active has-sub'><a href="#" ><span>Parameter</span></a>
                    <ul>
                        <li><a href="/PacsApplication/Trading_JSP/tradingProductCreation.jsp"><span>Trading Product Creation</span></a></li>
                    </ul>
                </li>
                <%}%>
                ...
                <li class='active has-sub'><a href="#" ><span>Operation</span></a>
                     ...
                     <ul>
                        <li><a href="/PacsApplication/Trading_JSP/RaisePurchaseOrder.jsp"><span>Raise Purchase Order</span></a></li>
                        <li><a href="/PacsApplication/Trading_JSP/TradingStockRegister.jsp"><span>Trading Stock Register</span></a></li>
                        <li><a href="/PacsApplication/Trading_JSP/TradingStockTransfer.jsp"><span>Trading Stock Transfer</span></a></li>
                        <li><a href="/PacsApplication/Trading_JSP/SellItem.jsp"><span>Trading Sell Item</span></a></li>
                        <li><a href="/PacsApplication/Trading_JSP/SalesRegister.jsp"><span>Trading Sales Register</span></a></li>
